...
const Services = () => {
  const servicesData: IService[] = getMarkDownData('src/data/services/home');
        ...
        <div className="space-y-[40px] md:space-y-[50px] lg:space-y-[60px] xl:space-y-[70px]">
          ...
          <div className="mx-auto max-w-[810px] space-y-5 text-center lg:w-full">
            <RevealAnimation delay={0.1}>
              <span className="badge badge-green mb-3 md:mb-4 lg:mb-5">Kullanım alanları
</span>
            </RevealAnimation>
            <div className="space-y-3">
              <RevealAnimation delay={0.2}>
                <h2>Belgeleri imzalamanın en kolay ve güvenli yolu</h2>
              </RevealAnimation>
              <RevealAnimation delay={0.3}>
                <p className="mx-auto max-w-[682px] sm:w-full">
                  E-imza ile belgelerinizi dakikalar içinde imzalayın, paylaşın ve arşivleyin. Zaman kazanın, kağıt masraflarını ortadan kaldırın ve iş süreçlerinizi tamamen dijital hale getirin. Her cihazda güvenle imzalayın.
                </p>
              </RevealAnimation>
            </div>
          </div>
